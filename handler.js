...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = '𝙻𝚎𝚖𝚘𝚗-𝙼𝚞𝚕𝚝𝚒𝙳𝚎𝚟𝚒𝚌𝚎'
        global.colong1 = '𝙻𝚎𝚖𝚘𝚗 𝙱𝚘𝚃𝚡'
        global.colong2 = 'ᵇʸ Lᴇᴍᴏɴ'
        global.kontak2 = [
        ['6285763482523', 'OᴡɴᴇʀBᴏT', 'Lᴇᴍᴏɴ', 'Oᴡɴᴇʀ', true],
        ['6285763482523', await this.getName('6285763482523@s.whatsapp.net'), 'Pᴀʀᴛɴᴇʀ', true], 
        ]
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.send3TemplateButtonImg(id, action === 'add' ? wel : lea, text, wm, action === 'add' ? '𝚈𝙾𝚆 𝙼𝙴𝙼𝙱𝙴𝚁 𝙱𝙰𝚁𝚄' : '𝙱𝚈𝙴', action === 'add' ? '.intro' : 'FokusID')
                        }
                    }
                }
                break
...
global.dfail = async (type, m, conn) => {
    let msg = {
        rowner: `_Command Ini Hanya Bisa Dipakai Oleh Team Lemon_`,
        owner: `_Command Ini Hanya Bisa Dipakai Oleh Owner_`,
        mods: `Command Ini Hanya Bisa Dipakai Oleh Moderator Bot`,
        premium: 'Command Ini Hanya Bisa Dipakai Oleh User Premium',
        group: `Command Ini Hanya Bisa Dipakai Di Group Chat`,
        private: 'Command Ini Hanya Bisa Diapakai Di Private Chat',
        admin: 'Command Ini Hanya Bisa Dipakai Oleh Admin',
        botAdmin: '_Bot Bukan Admin_',
        unreg: 'Silahkan Daftar Dulu Di Database Bot, Contoh \n .Daftar Lemon.20',
        nsfw: `NSFW Tidak Aktif, Silahkan Hubungi Team Lemon Untuk Mengaktifkannya`,
        rpg: `RPG Tidak Aktif, Silahkan Hubungi Team Lemon Untuk Mengaktifkannya`,
        restrict: 'Fitur Ini Di Matikan!!'
    }[type]
